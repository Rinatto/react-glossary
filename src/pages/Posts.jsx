...
function Posts() {
  const [posts] = useState([
    ...
    {id: 10, title: 'Статическая типизация', body: 'обуславливается тем, что конструкция, нуждающаяся в аннотации типа, связывается с типом данных, в момент объявления на этапе компиляции. При этом, связь с типом данных остается неизменна.' },
    {id: 11, title: 'Динамическая типизация', body: 'обусловлена тем, что конструкция, нуждающаяся в аннотации типа, связывается с типом данных на этапе выполнения программы, в момент присвоения значения. При этом связь с типом данных может быть изменена.' },
    {id: 12, title: 'Сильная типизация', body: 'не позволяет выражениям с несовместимыми типами выполняться и не выполняют неявное преобразование типов в ситуациях, когда нужно выполнять преобразование явно.' },
    {id: 13, title: 'Слабая типизация', body: 'не позволяет выражениям с несовместимыми типами выполняться и не выполняют неявное преобразование типов в ситуациях, когда нужно выполнять преобразование явно.' },
    {id: 14, title: 'Явная типизация', body: 'в программировании вид типизации, при котором в момент объявления переменной требуется явно указать ее тип.' },
    {id: 15, title: 'Неявная типизация', body: '– это определение факта реализации определённого интерфейса объектом без явного указания или наследования этого интерфейса, а просто по реализации полного набора его методов.' },
    {id: 16, title: 'JavaScript', body: 'язык программирования, который позволяет создавать динамически обновляемый контент, управлять мультимедиа, анимировать изображения и делать многое другое.' },
    {id: 17, title: 'TypeScript', body: '– это строго типизированный язык программирования, основанный на JavaScript.' },
  ])
  return (
    <div className="App">
